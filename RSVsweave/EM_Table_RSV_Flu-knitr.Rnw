...
for (qual in c('flumort','vir')){
  for (ag in 1:5){
    ...
    assign(paste0('newlineRSV',ag), paste0(ag,' & ',el1[1],' (',el1[2],',',el1[3],') & ',
                                           el2[1],' (',el2[2],',',el2[3],') & ',
                                           el3[1],' (',el3[2],',',el3[3],') & ',
                                           el4[1],' (',el4[2],',',el4[3],') & ',
                                           el5[1],' (',el5[2],',',el5[3],') & ',
    ...
    assign(paste0('newlineflu',ag), paste0(ag,' & ',el8[1],' (',el8[2],',',el8[3],') & ',
                                           el9[1],' (',el9[2],',',el9[3],') & ',
...
outc <- 'RSV'
for (ag in 1:5){
cat(paste0(eval(parse(text = paste0('newline',outc,ag))),'\n'))
}
@
\hline
\end{tabular}
